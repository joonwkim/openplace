...
const CommentButtons = ({ user, parentComment, showAddCommentBtn, thumbsStatus, thumbsUpCount, thumbsDownCount, handleThumbUp, handleThumbDown, handleSaveReplyComment }: CommentButtonsProps) => {
  ...
  const handleSaveCommentAndSetShowAddComment = async () => {
    await handleSaveReplyComment(parentComment.bulletinBoardId, parentComment.id, user.id, comment)
  ...
  return (
    <>
      <div className='d-flex'>
        ...
        {showAddCommentBtn && (<span className="ms-3" title='답글 추가' onClick={handleAddCommentOnComment}>
        ...
        {showAddComment && (<>
          <div className='col-11'>
            ...
            <div className="d-flex justify-content-md-end border-top gap-2">
              <button className="btn btn-light" type="button" onClick={handleSaveCommentAndSetShowAddComment}>저장</button>
