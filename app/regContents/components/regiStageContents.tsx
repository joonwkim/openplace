...
export const RegiStageContents = forwardRef<any, GenProps>(({ stage, handleCreateProject, setRegDataToSave, editMode }: GenProps, ref) => {
    ...
    return (
        <>
            {stage && <div className='mt-3 mx-2' onMouseOut={handleMouseOut}>
                ...
                {editMode && <AddContentsBtn ref={addContentsBtnRef} stage={stage} setRegDataToSave={getStageProjectData} handleCreateProject={handleCreateProject} />}
